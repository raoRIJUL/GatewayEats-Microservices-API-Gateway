    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationConverter converter)
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/restaurants", "/restaurants/**", "/items/**").permitAll()
                        .requestMatchers("/internal/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/restaurants", "/restaurants/*/items")
                            .hasRole("RESTAURANT_OWNER")
                        .requestMatchers(HttpMethod.PUT, "/items/**").hasRole("RESTAURANT_OWNER")
                        .requestMatchers(HttpMethod.DELETE, "/items/**").hasRole("RESTAURANT_OWNER")
                        .anyRequest().denyAll())
